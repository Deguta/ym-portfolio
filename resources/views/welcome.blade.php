          ...
          <div class="card-body">
            ...
            <div class="work-history-box1">
              ...
              <div class = "work-history-hidden-text1">
                ...
                そこで食品メーカーにお願いをして、専用のタレを作ってもらうように依頼しました。その結果、お客様から好評を頂き見事売上をV字回復しました。<br>
          ...
          <div class="card-body">
            ...
            <div class="dream-box">
              ...
              <div class="dream-hidden-text">
                　現在、不妊治療のクリニックに関する情報はとても少なく、インターネットにも医者の研究発表、治療による出生数しか掲載されていないため、
                どのクリニックがよいのか判断することが難しくなっています。<br>
                　このような私自身の経験も含めて不便な事を少しでも効率良くできる様にするにはどうしたら良いのかと思いました。
                偶然、前職でも注文履歴の管理や見積書作成を作成するwebアプリケーションが「JAVA]という言語で組み込まれていることが分かりました。
                プログラミング言語を学ぶことにより効率よく作業ができる様になるにはエンジニアしかないと思いました。
                少しでもwebアプリケーションを介して生産性を上げれる様になると思いエンジニアになろうと決意しました。
              </div>
            </div>
