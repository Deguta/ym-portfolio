            ...
            <p class="font-weight-bold text-center mt-3">
                ...
                <div class="hidden_box">
                  <label for="label1">学歴の詳細はこちら</label>
                    ...
                    <div class="hidden_show">
                      　部活動は新聞部と大学祭実行委員会に所属していました。新聞部では芸能人やスポーツ選手が多く訪ねてきます。
              ...
              <div class="hidden_box">
                ...
                <div class="hidden_show">
                  <div class="d-flex col-12 justify-content-center">
                    <div class="hashimoto col-6">
                      <img src="{{ asset('/images/.jpg') }}" class="img-thumbnail img-fluid mt-1"  alt="お造り写真1">
                      <p class="hashimoto-text text-dark">お造り写真</p>
                    </div>
  
                    <div class="owarai col-6">
                      <img src="{{ asset('/images/.jpg') }}" class="img-thumbnail img-fluid mt-1 mx-auto "  alt="お造り写真2">
                      <p class="owarai-text1 text-dark">お造り写真</p>
                    </div>
                  </div>
                  <p class="font-weight-bold text-center mt-3">
                    魚の食べ辛さを解消し
                  ...
                  <p>近鉄沿線の街の活性化し豊かな暮らしを支えるため食品を中心とした商品を販売。</p>

                  <p class="font-weight-bold mb-0">[主な担当]</p>
                  <p>水産の課長として任命され魚の加工・販売・接客を主とした仕事を6年半続けてきました。</p>

                  <p class="font-weight-bold mb-0">[成果]</p>
                  <p>2014年度 売上3億7800万円 予算達成率 105%　粗利 1800万</p>
      ...
      <div class="row no-gutters">
        <div class="card mt-5 mx-auto  col-md-9 md-offset-3">
          ...
          <div class="card-body ">
            ...
            <ul id="ul-requirement">
              <h3>資格一覧</h3>
              <li>販売士検定3級</li>
              <li>ファイナンシャルプランニング技能士3級</li>
              <li>マイクロソフト認定資格（MOS）Word スペシャリスト</li>
              <li>マイクロソフト認定資格（MOS）Excelスペシャリスト</li>
              <li>普通自動車免許第一種</li>
            </ul>
            <ul id="ul-skill">
              <h3>特技一覧</h3>
          ...
          <div class="card-body ">
            ...
            <p class="card-text left mt-3">
              ...
              <p>
                ...
                そこで当時マスク無しで仕事ができず、生産活動を止めざる負えないお客様が多くいらっしゃいましたので、さっそく上司へ提案をしました。
                立案として中国にも弊社の営業所はあります。至急マスクを生産できるところをチームメンバーで探しました。
